...
class Utils:
    ...
    SeatClientPath="programs/cliseat/cliseat"

    SeatWalletName="keyseatd"
    SeatWalletPath="programs/keyseatd/"+ SeatWalletName

    SeatServerName="nodeseat"
    SeatServerPath="programs/nodeseat/"+ SeatServerName

    SeatLauncherPath="programs/cubetrain-launcher/cubetrain-launcher"
    MongoPath="mongo"
    ShuttingDown=False
