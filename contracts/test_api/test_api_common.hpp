...
#ifdef DISABLE_SEATLIB_SERIALIZE
#include <cubetrainlib/serialize.hpp>
#undef SEATLIB_SERIALIZE
#define SEATLIB_SERIALIZE(...)
#endif
...
struct u128_action {
  ...
  SEATLIB_SERIALIZE( u128_action, (values) )
};
...
struct cf_action {
   ...
   SEATLIB_SERIALIZE( cf_action, (payload)(cfd_idx) )
};
...
struct dtt_action {
   ...
   SEATLIB_SERIALIZE( dtt_action, (payer)(deferred_account)(deferred_action)(permission_name)(delay_sec) )
};
...
struct invalid_access_action {
   ...
   SEATLIB_SERIALIZE( invalid_access_action, (code)(val)(index)(store) )
};
