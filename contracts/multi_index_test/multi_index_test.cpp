...
struct limit_order {
   ...
   account_name owner;
      ...
      SEATLIB_SERIALIZE( limit_order, (id)(price)(expiration)(owner) )
   };
   ...
   struct test_k256 {
      ...
      SEATLIB_SERIALIZE( test_k256, (id)(val) )
   };
   ...
   class multi_index_test {
      public:
         ...
         ACTION(N(multitest), trigger) {
            ...
            SEATLIB_SERIALIZE(trigger, (what))
         };
         ...
         static void on(const trigger& act)
         {
            ...
            switch(act.what)
            {
               case 0:
               {
                  ...
                  cubetrain::multi_index<N(orders), limit_order,
               ...
               case 1: // Test key265 secondary index
               {
                  ...
                  cubetrain::multi_index<N(test1), test_k256,
               ...
               break;
               default:
                  cubetrain_assert(0, "Given what code is not supported.");
               break;
            }
         }
   };
...
namespace multi_index_test {
   extern "C" {
      ...
      void apply( uint64_t /* receiver */, uint64_t code, uint64_t action ) {
         require_auth(code);
         cubetrain_assert(cubetrain::dispatch<multi_index_test, multi_index_test::trigger>(code, action),
                      "Could not dispatch");
      }
   }
}
