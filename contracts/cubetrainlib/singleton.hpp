...
namespace  cubetrain {
    ...
    *  @brief Defines CUBETRAIN Singleton Table
    *  @ingroup databasecpp 
    *  @{
    */
   ...
   class singleton
   {
      ...
      struct row {
         ...
         SEATLIB_SERIALIZE( row, (value) )
      };

      typedef cubetrain::multi_index<SingletonName, row> table;
      ...
      public:
         ...
         T get() {
            ...
            cubetrain_assert( itr != _t.end(), "singleton does not exist" );
            return itr->value;
         }
