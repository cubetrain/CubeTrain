 ...
 * @ingroup types
 * @brief Defines contract type which is %base class for every CUBETRAIN contract
 * 
 * @{
 * 
 */
...
/**
 * @brief %Base class for CUBETRAIN contract.
 * @details %Base class for CUBETRAIN contract. %A new contract should derive from this class, so it can make use of CUBETRAIN_ABI macro.
 */
class contract {
   public:
      /**
