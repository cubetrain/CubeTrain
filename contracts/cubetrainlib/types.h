...
/**
 * @brief CUBETRAIN Public Key
 * @details CUBETRAIN Public Key. It is 34 bytes.
 */
struct public_key {
   char data[34];
};
...
/**
 * @brief CUBETRAIN Signature
 * @details CUBETRAIN Signature. It is 66 bytes.
 */
struct signature {
   uint8_t data[66];
};
...
/**
 * @brief Type of CUBETRAIN Transaction Id
 * @details Type of CUBETRAIN Transaction Id. It is 256-bit hash
 */
