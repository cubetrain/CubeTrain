 ...
 *  cubetrain::print("sha256 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  cubetrain::print("sha1 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  cubetrain::print("sha512 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  cubetrain::print("ripemod160 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  seat_assert( calc_hash == hash, "invalid hash" );
 *  @endcode
 */
 ...
 *  cubetrain::print("pub key matches the pub key generated from digest");
 *  @endcode
 */
