...
## cubetrain.system::cfgproducer    account config
...
## cubetrain.system::okproducer     account producer vote
...
## cubetrain.system::setproxy       account proxy
...
## cubetrain.system::unstake        account quantity 
...
## cubetrain.system::withdraw account
   - this action can only be triggered by cubetrain.system via a deferred transaction generated by unstake
   - this will generate an inline cubetrain.tk::transfer call from=cubetrain.system to=account and amount equal to the next withdraw increment
   - this will generate another deferred withdraw to continue the process if there are still withdraws to be made


## cubetrain.system::transfer from to amount memo
   - decrements balance of from if amount <= balance
   - increments balance of to by amount
   - memo is ignored 

## cubetrain.system::stakevote account amount
   - the primary currency of cubetrain is controlled by the token contract which enables users to transfer
...
## cubetrain.system::onblock   account blocktime blocknum
...
## cubetrain.system::freeze producer accounts true|false 
...
## cubetrain.system::paystandby producer
