...
import Api from "../seatjs-api";
import JsonRpc from "../seatjs-jsonrpc";
import JsSignatureProvider from "../seatjs-jssig";
...
describe("seatjs-api", () => {
    ...
    it("getAbi returns an abi", async () => {
        const response = await api.getAbi("testseattoken");
    ...
    it("getContract returns a contract", async () => {
        const response = await api.getContract("testseattoken");
