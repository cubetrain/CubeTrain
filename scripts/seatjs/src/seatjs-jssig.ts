...
import * as ecc from "seatjs-ecc";
import { SignatureProvider, SignatureProviderArgs } from "./seatjs-api-interfaces";
import { convertLegacyPublicKey } from "./seatjs-numeric";
