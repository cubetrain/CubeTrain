#!/bin/bash
#
# cubetrain-tn_down.sh is used by the cubetrain-tn_bounce.sh and cubetrain-tn_roll.sh scripts.
# It is intended to terminate specific CUBETRAIN_SEAT daemon processes.
#
