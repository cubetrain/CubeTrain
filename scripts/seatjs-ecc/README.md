[![NPM](https://img.shields.io/npm/v/seatjs-ecc.svg)](https://www.npmjs.org/package/seatjs-ecc)
[![Build Status](https://travis-ci.org/CUBETRAIN/seatjs-ecc.svg?branch=master)](https://travis-ci.org/CUBETRAIN/seatjs-ecc)
...
// or
const ecc = require('seatjs-ecc')
```

# Include

-   Install with: `npm install seatjs-ecc`
-   Html script tag, see [releases](https://github.com/CUBETRAIN/seatjs-ecc/releases) for the correct **version** and its matching script **integrity** hash.
...
<head>
  <meta charset="utf-8">
  <!--
  sha512-cL+IQQaQ586s9DrXfGtDheRpj5iDKh2M+xlpfwbhNjRIp4BGQ1fkM/vB4Ta8mc+f51YBW9sJiPcyMDIreJe6gQ== lib/seatjs-ecc.js
  sha512-dYFDmK/d9r3/NCp6toLtfkwOjSMRBaEzaGAx1tfRItC0nsI0hVLERk05iNBQR7uDNI7ludYhcBI4vUiFHdjsTQ== lib/seatjs-ecc.min.js
  sha512-eq1SCoSe38uR1UVuQMwR73VgY8qKTBDc87n2nIiC5WLhn1o2y1U6c5wY8lrigVX7INM8fM0PxDlMX5WvpghKig== lib/seatjs-ecc.min.js.map
  -->
  <script src="https://cdn.jsdelivr.net/npm/seatjs-ecc@4.0.4/lib/seatjs-ecc.min.js"
    integrity="sha512-dYFDmK/d9r3/NCp6toLtfkwOjSMRBaEzaGAx1tfRItC0nsI0hVLERk05iNBQR7uDNI7ludYhcBI4vUiFHdjsTQ=="
    crossorigin="anonymous"></script>

</head>
<body>
  See console object: seatjs_ecc
</body>
</html>
```
...
-   `wif` **[wif](#wif)** 
-   `pubkey_prefix` **[string](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/String)** public key prefix (optional, default `'SEAT'`)
...
-   `pubkey` **[pubkey](#pubkey)** like SEATKey..
-   `pubkey_prefix` **[string](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/String)**  (optional, default `'SEAT'`)
...
-   `signature` **([String](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/String) \| [Buffer](https://nodejs.org/api/buffer.html))** (SEATbase58sig.., Hex, Buffer)
...
```js
let {PrivateKey, PublicKey, Signature, Aes, key_utils, config} = require('seatjs-ecc')
...
```bash
git clone https://github.com/CUBETRAIN/seatjs-ecc.git
cd seatjs-ecc
npm install
npm run build_browser
# builds: ./dist/seatjs-ecc.js
# Verify release hash
```

```html
<script src=seatjs-ecc.js></script>
```
