...
class deferred_test : public cubetrain::contract {
   public:
      ...
      void deferfunc( uint64_t payload ) {
         ...
         cubetrain_assert( payload != 13, "value 13 not allowed in payload" );
      }
...
//CUBETRAIN_ABI( deferred_test, (defercall)(deferfunc) )
