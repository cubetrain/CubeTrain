...
class soft_wallet final : public wallet_api
{
   public:
       ...
       *
       * example: remove_key SEAT6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV
       *
...
FC_REFLECT( cubetrain::wallet::wallet_data, (cipher_keys) )

FC_REFLECT( cubetrain::wallet::plain_keys, (checksum)(keys) )
