...
FC_REFLECT( cubetrain::select_ids<fc::sha256>, (mode)(pending)(ids) )
FC_REFLECT( cubetrain::chain_size_message,
            (last_irreversible_block_num)(last_irreversible_block_id)
            (head_num)(head_id))
FC_REFLECT( cubetrain::handshake_message,
            (network_version)(chain_id)(node_id)(key)
            (time)(token)(sig)(p2p_address)
            (last_irreversible_block_num)(last_irreversible_block_id)
            (head_num)(head_id)
            (os)(agent)(generation) )
FC_REFLECT( cubetrain::go_away_message, (reason)(node_id) )
FC_REFLECT( cubetrain::time_message, (org)(rec)(xmt)(dst) )
FC_REFLECT( cubetrain::notice_message, (known_trx)(known_blocks) )
FC_REFLECT( cubetrain::request_message, (req_trx)(req_blocks) )
FC_REFLECT( cubetrain::sync_request_message, (start_block)(end_block) )
