...
CHAINBASE_SET_INDEX_TYPE( cubetrain::public_key_history_object, cubetrain::public_key_history_multi_index )

FC_REFLECT( cubetrain::public_key_history_object, (public_key)(name)(permission) )
