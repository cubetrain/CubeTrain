...
CHAINBASE_SET_INDEX_TYPE( cubetrain::account_control_history_object, cubetrain::account_control_history_multi_index )

FC_REFLECT( cubetrain::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
