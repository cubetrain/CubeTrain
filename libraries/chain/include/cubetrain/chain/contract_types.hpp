...
using action_name    = cubetrain::chain::action_name;
...
FC_REFLECT( cubetrain::chain::newaccount                       , (creator)(name)(owner)(active) )
FC_REFLECT( cubetrain::chain::setcode                          , (account)(vmtype)(vmversion)(code) )
FC_REFLECT( cubetrain::chain::setabi                           , (account)(abi) )
FC_REFLECT( cubetrain::chain::updateauth                       , (account)(permission)(parent)(auth) )
FC_REFLECT( cubetrain::chain::deleteauth                       , (account)(permission) )
FC_REFLECT( cubetrain::chain::linkauth                         , (account)(code)(type)(requirement) )
FC_REFLECT( cubetrain::chain::unlinkauth                       , (account)(code)(type) )
FC_REFLECT( cubetrain::chain::canceldelay                      , (canceling_auth)(trx_id) )
FC_REFLECT( cubetrain::chain::onerror                          , (sender_id)(sent_trx) )
