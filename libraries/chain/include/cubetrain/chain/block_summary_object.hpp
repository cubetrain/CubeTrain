...
CHAINBASE_SET_INDEX_TYPE(cubetrain::chain::block_summary_object, cubetrain::chain::block_summary_multi_index)

FC_REFLECT( cubetrain::chain::block_summary_object, (block_id) )
