...
#include <cubetrain/chain/incremental_merkle.hpp>
...
CHAINBASE_SET_INDEX_TYPE(cubetrain::chain::global_property_object, cubetrain::chain::global_property_multi_index)
CHAINBASE_SET_INDEX_TYPE(cubetrain::chain::dynamic_global_property_object,
                         cubetrain::chain::dynamic_global_property_multi_index)

FC_REFLECT(cubetrain::chain::dynamic_global_property_object,
           (global_action_sequence)
          )

FC_REFLECT(cubetrain::chain::global_property_object,
