...
struct abi_def {
   ...
   string                version = "cubetrain::abi/1.0";
...
FC_REFLECT( cubetrain::chain::type_def                         , (new_type_name)(type) )
FC_REFLECT( cubetrain::chain::field_def                        , (name)(type) )
FC_REFLECT( cubetrain::chain::struct_def                       , (name)(base)(fields) )
FC_REFLECT( cubetrain::chain::action_def                       , (name)(type)(ricardian_contract) )
FC_REFLECT( cubetrain::chain::table_def                        , (name)(index_type)(key_names)(key_types)(type) )
FC_REFLECT( cubetrain::chain::clause_pair                      , (id)(body) )
FC_REFLECT( cubetrain::chain::error_message                    , (error_code)(error_msg) )
FC_REFLECT( cubetrain::chain::abi_def                          , (version)(types)(structs)(actions)(tables)
