...
#include <cubetrain/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(cubetrain::chain::table_id_object, cubetrain::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(cubetrain::chain::key_value_object, cubetrain::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(cubetrain::chain::index64_object, cubetrain::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(cubetrain::chain::index128_object, cubetrain::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(cubetrain::chain::index256_object, cubetrain::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(cubetrain::chain::index_double_object, cubetrain::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(cubetrain::chain::index_long_double_object, cubetrain::chain::index_long_double_index)

FC_REFLECT(cubetrain::chain::table_id_object, (id)(code)(scope)(table) )
FC_REFLECT(cubetrain::chain::key_value_object, (id)(t_id)(primary_key)(value)(payer) )
