...
CHAINBASE_SET_INDEX_TYPE(cubetrain::chain::permission_link_object, cubetrain::chain::permission_link_index)

FC_REFLECT(cubetrain::chain::permission_link_object, (id)(account)(code)(message_type)(required_permission))
