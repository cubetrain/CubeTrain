...
CHAINBASE_SET_INDEX_TYPE(cubetrain::chain::permission_object, cubetrain::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(cubetrain::chain::permission_usage_object, cubetrain::chain::permission_usage_index)

FC_REFLECT(chainbase::oid<cubetrain::chain::permission_object>, (_id))
FC_REFLECT(cubetrain::chain::permission_object, (id)(usage_id)(parent)(owner)(name)(last_updated)(auth))

FC_REFLECT(chainbase::oid<cubetrain::chain::permission_usage_object>, (_id))
FC_REFLECT(cubetrain::chain::permission_usage_object, (id)(last_used))
