...
FC_REFLECT(cubetrain::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(cubetrain::chain::key_weight, (key)(weight) )
FC_REFLECT(cubetrain::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(cubetrain::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(cubetrain::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
